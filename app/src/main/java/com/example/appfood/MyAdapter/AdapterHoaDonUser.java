...
import com.example.appfood.MyView.Bill.ActivityContentBillUser;

import java.text.NumberFormat;
import java.util.ArrayList;

public class AdapterHoaDonUser extends RecyclerView.Adapter<AdapterHoaDonUser.ViewHodler> {
    // Variables
    private Context context;
    private ArrayList<HoaDon> arrayList;
    private  int type = 0;

    public AdapterHoaDonUser(Context context, ArrayList<HoaDon> arrayList) {
        this.context = context;
        this.arrayList = arrayList;
    }
    public AdapterHoaDonUser(Context context, ArrayList<HoaDon> arrayList, int type) {
        this.context = context;
        this.arrayList = arrayList;
        this.type= type;
    }
    ...
    @NonNull
    @Override
    public AdapterHoaDonUser.ViewHodler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        if(type==0 || type==5){
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterHoaDonUser.ViewHodler holder, int position) {
        ...
        holder.SetOnItem(new InterSetOnItemClick() {
            ...
            public void SetItemClick(View view, int pos) {
                Intent intent = new Intent(context, ActivityContentBillUser.class);
